/**
 * Test script for Stripe checkout with Apple Pay payment method
 */
...
async function testApplePayment() {
  console.log("\n===== Testing Apple Pay Payment =====");
  ...
  try {
    const data = {
      ...
      paymentMethodTypes: ['card', 'apple_pay'] // This should be filtered correctly by the backend
    };
