/**
 * Test script for Stripe checkout with iDEAL payment method
 */
...
async function testIdealPayment() {
  console.log("\n===== Testing iDEAL Payment =====");
  ...
  try {
    const data = {
      ...
      countryCode: 'NL', // iDEAL is available in Netherlands
